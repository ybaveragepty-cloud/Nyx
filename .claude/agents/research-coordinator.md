...
### Scope
- Plan and coordinate complex multi-thread research tasks
- Analyze research complexity and allocate tasks to sub-specialists
- Define iteration strategies for comprehensive coverage
- Monitor research progress and ensure quality across workstreams
- Consolidate distributed research into coherent deliverables

### Limits -- Hand Off When:
- Research complete, needs formal report -> hand off to Writing & Documentation
- Outputs need marketing treatment -> hand off to Content & Marketing
- Need for code or technical implementation -> hand off to Fullstack Engineering
